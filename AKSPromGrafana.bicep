...
// create managed identity cluster
@description('The name of the Managed Cluster resource.')
param aksclusterName string = 'aks101cluster'
...
param monitorworkspacename string = 'monitorWorkspace'
param loganalyticsworkspacename string

var managedGrafanaWorkspacename = 'grfwk${uniqueString(resourceGroup().id)}'
...
var var_loganalyticsworkspaceID = loganalyticsworkspace.id

//var azureMonitorWorkspaceLocation  = monitorworkspace.location
var azureMonitorWorkspaceLocation  = location
var azureMonitorWorkspaceResourceId = monitorworkspace.id

//create managed grafana and link to monitor
resource managedGrafanaWorkspace 'Microsoft.Dashboard/grafana@2022-08-01' ={
  name: managedGrafanaWorkspacename
  location: location
  sku:{
    name: grafanaSku
  }
...
var grafanaResourceId = managedGrafanaWorkspace.id

//var grfwkIntegrations = managedGrafanaWorkspace.properties.grafanaIntegrations.azureMonitorWorkspaceIntegrations
...
var clusterResourceId  = aks.id
var clusterLocation = aks.location
...
var nodeRecordingRuleGroupName = '${nodeRecordingRuleGroup_var}${clusterName}'
...
var kubernetesRecordingRuleGroupName = '${kubernetesRecordingRuleGroup_var}${clusterName}'
...
var nodeRecordingRuleGroupNameWin_var = '${nodeRecordingRuleGroupWin}${clusterName}'
var nodeAndKubernetesRecordingRuleGroupWin_var = '${nodeAndKubernetesRecordingRuleGroupWin}${clusterName}'
...
module azuremonitormetrics_profile_clusterResourceId './nested_azuremonitormetrics_profile_clusterResourceId.bicep' = {
  ...
  params: {
    ...
    loganalyticsworkspaceID : var_loganalyticsworkspaceID
  }
  dependsOn: [
...
resource roleNameGuid_resource 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  ...
  properties: {
    ...
    principalId: reference(grafanaResourceId, '2022-08-01', 'Full').identity.principalId
  }
}
